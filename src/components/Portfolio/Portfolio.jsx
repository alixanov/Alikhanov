...
const Portfolio = () => {
  const slider = [
    ...
    },
    {
      ...
      descriptionPortfolio:
        "«Школа будущего» — это инновационное образовательное пространство, где каждый ученик получает персонализированный подход и современные знания. Мы готовим лидеров завтрашнего дня, развивая навыки 21 века: креативность, критическое мышление и цифровую грамотность. Присоединяйтесь к нам и откройте новые горизонты для вашего ребенка!",
